...
export async function GET(request: NextRequest) {
  try {
    ...
    // Find highest emotional load project
    ...
    // Weekly trend: Compare sum of emotional weights of active tasks created this week vs last week.
    ...
    console.error("Get TDAH stats error:", error);
